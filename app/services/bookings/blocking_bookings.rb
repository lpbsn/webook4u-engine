...
module Bookings
  module BlockingBookings
    ...
    # [start_time, end_time) for the given client.
    def overlapping(client:, start_time:, end_time:, exclude_booking_id: nil)
    ...
    def intervals_for_range(client:, range_start:, range_end:)
      overlapping(client: client, start_time: range_start, end_time: range_end)
